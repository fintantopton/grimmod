...
| `display.hdpi_fix = true/false`       | true (Windows) / false (Linux) | GrimMod rewrites some of the window handling to always render at native resolution. Not applicable on Linux. |
