...
// ---- Struct definitions ----
//
// These are #[repr(C)] and must match the game binary's ABI (32-bit on
// Windows/Linux, with 4-byte pointers).
...
/// A compiled shader program. grimmod accesses shader indirectly through
