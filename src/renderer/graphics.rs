...
/// On Windows, persistent GL hooks are not used. The per-frame
...
/// On 32-bit Windows, u32 == pointer size so this doesn't matter.
#[cfg(not(target_os = "macos"))]
...
/// On Windows, uses per-frame hook/unhook of sampler_parameteri.
